...
def reset(reset_state=True):
	global agents, goal_density, coverage_density, heat, coverage_block, param, controls, paths, target_reached
...
# ===============================
def update():
	global agents, goal_density, coverage_density, heat, coverage_block, param, paths, target_reached
	...
	command(agents, goal_density, coverage_density, heat, coverage_block, param)
